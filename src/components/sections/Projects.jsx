        ...
        <div className="max-w-5xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        <img
                            src="./projects/ocr_logo.jpg"
                            alt="Plant Disease Detection"
                            className="rounded-lg mb-4 w-full h-40 object-cover"
                        />
                        <h3 className="text-xl font-bold mb-2">OCR Pipeline</h3>
                        <p className="text-gray-400 mb-3">
                            An AI-powered OCR platform that accurately extracts structured text from PDFs, scanned documents, and images using PaddleOCR and intelligent image preprocessing, with support for multiple export formats.
                        </p>
                        <div className="flex flex-wrap gap-2 mb-4">
                            {["HuggingFace", "Python", "PaddleOCR", "Pdfplumber"].map((tech, key) => (
                            <span
                                key={key}
                        ...
                        <div className="flex justify-between items-center">
                            <a href="https://huggingface.co/spaces/basanth1/OCR-pipeline" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View Project &#8594;</a>
                        </div>
                    </div>
                    <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all">
                        <img
